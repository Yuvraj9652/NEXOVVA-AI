...
def seed_broadcast_campaigns():
    ...
    campaigns_data = [
        {
            ...
            "content": "Discover DLF Cyber Horizon, Gurugram's finest high-rise luxury towers with private sky lounges, infinity pools, and 360 panoramic views. VIP site visits open now!",
        ...
        },
        {
            ...
            "content": "Experience peaceful living surrounded by nature at Prestige Elysian Woods. Private heated pools, solar power backup, and 40,000 sq ft clubhouse.",
        ...
        },
        {
            ...
            "content": "Panoramic skyline views, smart automation, and direct Metro access at Oberoi Sky City Penthouses. Pre-booking now open.",
    ...
    for cdata in campaigns_data:
        campaign, created = BroadcastCampaign.objects.get_or_create(
            name=cdata["name"],
            organization=org,
            defaults={**cdata}
        )
        ...
        print(f"Broadcast Campaign '{campaign.name}' seeded!")
